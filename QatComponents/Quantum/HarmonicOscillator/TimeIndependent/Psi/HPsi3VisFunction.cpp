...
class HPsi3VisFunction: public VisFunction {
 
public:
 
  HPsi3VisFunction():VisFunction("Psi_3") {
...
extern "C" HPsi3VisFunction *create_HPsi3VisFunction()  {
  return new HPsi3VisFunction();
}
