...
class HPsi4VisFunction: public VisFunction {
 
public:
 
  HPsi4VisFunction():VisFunction("Psi_4") {
...
extern "C" HPsi4VisFunction *create_HPsi4VisFunction()  {
  return new HPsi4VisFunction();
}
