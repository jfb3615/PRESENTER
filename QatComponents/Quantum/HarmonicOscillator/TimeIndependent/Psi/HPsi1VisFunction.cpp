...
class HPsi1VisFunction: public VisFunction {
 
public:
 
  HPsi1VisFunction():VisFunction("Psi_1") {
...
extern "C" HPsi1VisFunction *create_HPsi1VisFunction()  {
  return new HPsi1VisFunction();
}
