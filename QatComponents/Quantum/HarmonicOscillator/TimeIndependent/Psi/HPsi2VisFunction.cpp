...
class HPsi2VisFunction: public VisFunction {
 
public:
 
  HPsi2VisFunction():VisFunction("Psi_2") {
...
extern "C" HPsi2VisFunction *create_HPsi2VisFunction()  {
  return new HPsi2VisFunction();
}
