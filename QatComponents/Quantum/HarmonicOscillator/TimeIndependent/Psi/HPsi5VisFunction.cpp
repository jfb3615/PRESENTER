...
class HPsi5VisFunction: public VisFunction {
 
public:
 
  HPsi5VisFunction():VisFunction("Psi_5") {
...
extern "C" HPsi5VisFunction *create_HPsi5VisFunction()  {
  return new HPsi5VisFunction();
}
