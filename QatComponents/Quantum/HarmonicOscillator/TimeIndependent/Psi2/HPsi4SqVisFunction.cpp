...
class HPsi4SqVisFunction: public VisFunction {
 
public:
 
  HPsi4SqVisFunction():VisFunction("Psi^2_4") {
...
extern "C" HPsi4SqVisFunction *create_HPsi4SqVisFunction()  {
  return new HPsi4SqVisFunction();
}
