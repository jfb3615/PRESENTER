...
class HPsi5SqVisFunction: public VisFunction {
 
public:
 
  HPsi5SqVisFunction():VisFunction("Psi^2_5") {
...
extern "C" HPsi5SqVisFunction *create_HPsi5SqVisFunction()  {
  return new HPsi5SqVisFunction();
}
