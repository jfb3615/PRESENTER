...
class HPsi3SqVisFunction: public VisFunction {
 
public:
 
  HPsi3SqVisFunction():VisFunction("Psi^2_3") {
...
extern "C" HPsi3SqVisFunction *create_HPsi3SqVisFunction()  {
  return new HPsi3SqVisFunction();
}
