...
class HPsi2SqVisFunction: public VisFunction {
 
public:
 
  HPsi2SqVisFunction():VisFunction("Psi^2_2") {
...
extern "C" HPsi2SqVisFunction *create_HPsi2SqVisFunction()  {
  return new HPsi2SqVisFunction();
}
