...
class HPsi0SqVisFunction: public VisFunction {
 
public:
 
  HPsi0SqVisFunction():VisFunction("Psi^2_0") {
...
extern "C" HPsi0SqVisFunction *create_HPsi0SqVisFunction()  {
  return new HPsi0SqVisFunction();
}
