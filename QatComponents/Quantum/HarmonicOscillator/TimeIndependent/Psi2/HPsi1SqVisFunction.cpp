...
class HPsi1SqVisFunction: public VisFunction {
 
public:
 
  HPsi1SqVisFunction():VisFunction("Psi^2_1") {
...
extern "C" HPsi1SqVisFunction *create_HPsi1SqVisFunction()  {
  return new HPsi1SqVisFunction();
}
